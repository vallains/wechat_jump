...
//                            notFound = false;
    ...
    private static void doJump(int distance)
    {
        ...
        //执行按压操作
        String command = String.format("adb shell input swipe %s %s %s %s %s", randomX(), randomY(), randomX(), randomY(),
                pressTime);
